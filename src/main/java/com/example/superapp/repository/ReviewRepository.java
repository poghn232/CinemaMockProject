...
public interface ReviewRepository extends JpaRepository<Review, Long> {
    ...
    // Profile-based lookups (for comment feature)
    List<Review> findByProfile_ProfileId(Long profileId);

    // Rating lookups still support username via profile.user.username path
    Optional<Review> findByMovieIdAndProfile_User_Username(Long movieId, String username);
    Optional<Review> findByEpisodeIdAndProfile_User_Username(Long episodeId, String username);

    Optional<Review> findTopByMovieIdAndProfile_User_UsernameOrderByCreatedDateDesc(Long movieId, String username);
    Optional<Review> findTopByEpisodeIdAndProfile_User_UsernameOrderByCreatedDateDesc(Long episodeId, String username);
